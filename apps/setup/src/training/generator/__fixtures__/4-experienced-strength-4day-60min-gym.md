# Experienced · Get stronger · 4 days · 60 min · Gym
...
- Weekly volume for glutes (16 sets) exceeds the target range (6-12).
- Weekly volume for chest (5 sets) is below the target range (6-12).
- Weekly volume for triceps (13 sets) exceeds the target range (6-12).
- Weekly volume for back (14 sets) exceeds the target range (6-12).
- Weekly volume for hamstrings (5 sets) is below the target range (6-12).
- Weekly volume for shoulders (5 sets) is below the target range (6-12).
