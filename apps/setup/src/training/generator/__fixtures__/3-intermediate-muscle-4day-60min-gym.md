# Intermediate · Build muscle · 4 days · 60 min · Gym

## Lower Body — ~36 min

**Warm-up:** Dynamic warm-up flow (1 × 60s hold · rest 0s)
...
**Warm-up:** Upper body dynamic warm-up (1 × 60s hold · rest 0s)
...
- Weekly volume for core (8 sets) is below the target range (10-20).
- Weekly volume for calves (6 sets) is below the target range (10-20).
- Weekly volume for chest (6 sets) is below the target range (10-20).
- Weekly volume for triceps (9 sets) is below the target range (10-20).
- Weekly volume for back (9 sets) is below the target range (10-20).
- Weekly volume for shoulders (9 sets) is below the target range (10-20).
- Weekly volume for hamstrings (6 sets) is below the target range (10-20).
- Weekly volume for biceps (3 sets) is below the target range (10-20).
